...
public class AuthenticationService {
    ...
    public AuthenticationResponse registerUser(RegisterRequest request) {
        ...
        claims.put("fullName", savedUser.getPrenom() + " " + savedUser.getNom());
        ...
        emailSendService.sendEmail(
                request.getEmail(),
                buildEmail(request.getPrenom(),
                        link),"Confirme you password");
    ...
    private String buildEmail(String name, String link) {
        return "<html xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\" style=\"font-family:arial, 'helvetica neue', helvetica, sans-serif\"><head><meta http-equiv=\"Content-Security-Policy\" content=\"script-src 'none'; connect-src 'none'; object-src 'none'; form-action 'none';\">\n" +
                "  <meta charset=\"UTF-8\">\n" +
                "  <meta content=\"width=device-width, initial-scale=1\" name=\"viewport\">\n" +
                "  <meta name=\"x-apple-disable-message-reformatting\">\n" +
                "  <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">\n" +
                "  <meta content=\"telephone=no\" name=\"format-detection\">\n" +
                "  <title>Finish registration</title><!--[if (mso 16)]>\n" +
                "    <style type=\"text/css\">\n" +
                ...
                "                     <tbody><tr>\n" +
                "                      <td align=\"center\" style=\"padding:0;Margin:0;position:relative\"><img class=\"adapt-img\" src=\"https://demo.stripocdn.email/content/guids/bannerImgGuid/images/image1679960333314198.png\" alt=\"\" title=\"\" width=\"510\" style=\"display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic\"></td>\n" +
                "                     </tr>\n" +
                "                   </tbody></table></td>\n" +
                "                 </tr>\n" +
                "               </tbody></table></td>\n" +
    ...
    public String confirmToken(String token) {
        ...
        checkTokenValidity(confirmationToken);
        confirmationTokenService.setConfirmedAt(token);
        confirmationTokenService.deleteToken(token);
        enableUser(confirmationToken.getUtlisateur().getEmail());
        return "confirmed";
    }

    private void enableUser(String email) {
        utilisateurService.enableAppUser(email);
    }
    ...
    private void checkTokenValidity(ConfirmationToken confirmationToken) {
